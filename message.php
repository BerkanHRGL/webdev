    ...
    switch ($alert) {
        ...
        case "register-error" :
            echo '<div class="alert alert-danger mt-5 text-center w-50 mx-auto" role="alert">
             Oeps! Er is iets misgegaan tijdens het registreren, probeer het opnieuw of neem contact op met klantenservice@senzubeans.nl.
             </div>';
            header("Refresh: 6; ./index.php?content=registreer");
        break;
