            ...
            if (mysqli_query($conn, $sql)) {
                ...
                $message = '<!doctype html>
                                ...
                                <body>
                                    ...
                                    <p>Je hebt je onlangs geregistereerd voor de site https://senzu-beans.000webhostapp.com/</p>
                                    <p>Klik <a href=https://senzu-beans.000webhostapp.com/index.php?content=activate&id=' . $id . '&pwh=' . $array['password_hash'] . '">hier</a> voor het activeren en/of wijzigen van het wachtwoord van je account.</p>
                                    <p>Bedankt voor het registreren!</p>
                                    <p>Met vriendelijke groet,</p>
                                    <p>Team Senzu-Beansr</p>
                ...
                $headers .= "From: noreply@senzubeans.nl\r\n";
                $headers .= "Cc: admin@senzubeans.nl\r\n";
                $headers .= "Bcc: moderator@senzubeans.nl";
